...
<div class="my-container">
    ...
    <div class="my-content"> <!-- 修正ポイント -->
        ...
        <div class="my-favorites"> <!-- 修正ポイント -->
            <h2>お気に入り店舗</h2>
            <div class="my-favo_container">
                @foreach($favorites as $favorite)
                <div class="my-favo_card">
                    <form class="my-favo_form" action="/detail" method="get">
                        ...
                        <div class="my-favo_btn-group">
                            <a href="/detail/{{ $favorite->shop_id }}" class="my-favo_btn">詳しく見る</a>
                            @if (Auth::check() && Auth::user()->hasVerifiedEmail())
                            <a href="/favo_delete/{{ $favorite->shop_id }}" class="my-favo_heart-icon"><img src="{{ asset('images/filled-heart.png') }}" alt="お気に入り解除" class="my-favo_heart-icon"></a>
                            @endif
                        </div>
                    </form>
                </div>
