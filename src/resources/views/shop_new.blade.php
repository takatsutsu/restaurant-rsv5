...
<div class="shop_edit_container">
    ...
    <form class="shop_edit_form" action="shop_store" method="POST" novalidate>
        @csrf

        <div class="shop_edit_group">
            <label for="shop_name">店舗名</label>
            <input type="text" name="shop_name" id="shop_name" class="shop-edit_name" value="{{ old('shop_name')}}" required>
            <font color="red">
                @error('shop_name')
                    {{$message }}
                @enderror
        ...
        <div class="shop_edit_group">
            ...
            <textarea name="shop_explanation" id="shop_explanation" class="shop-edit_explanation" required>{{ old('shop_explanation') }}</textarea>
            <font color="red">
        ...
        <button type="submit" class="btn btn-primary shop-edit_button">登録</button>
    </form>
</div>
@endsection